...
class ReferencesControllerTest < ActionDispatch::IntegrationTest
  ...
  test "should create reference" do
    assert_difference('Reference.count') do
      post references_url, params: { reference: { entity_id: @reference.entity_id, snippet_id: @reference.snippet_id } }, as: :json
    end
  ...
  test "should update reference" do
    patch reference_url(@reference), params: { reference: { entity_id: @reference.entity_id, snippet_id: @reference.snippet_id } }, as: :json
    assert_response 200
  end
