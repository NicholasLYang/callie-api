...
class SnippetsControllerTest < ActionDispatch::IntegrationTest
  ...
  test "should create snippet" do
    assert_difference('Snippet.count') do
      post snippets_url, params: { snippet: { call_id: @snippet.call_id, transcript: @snippet.transcript } }, as: :json
    end
  ...
  test "should update snippet" do
    patch snippet_url(@snippet), params: { snippet: { call_id: @snippet.call_id, transcript: @snippet.transcript } }, as: :json
    assert_response 200
  end
